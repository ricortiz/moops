#ifndef IMMERSED_VOLUME_HPP
#define IMMERSED_VOLUME_HPP
...
template<typename particle_system_type,
         ...
         >
         class ImmersedVolume : public particle_system_type, public integration_policy<ImmersedVolume<particle_system_type,immersed_surface_type,fluid_solver_type,integration_policy> >
{ 
    public:
    ...
    public:
        ...
        ImmersedVolume(immersed_surface_type *surface) : m_surface(surface), m_fluid_solver(surface->fluid_solver()) {  }
        ~ImmersedVolume() {}
...
struct immersed_structure_traits<ImmersedVolume<_particle_system_type,_immersed_surface_type,_fluid_solver_type,_integration_policy> >
{
